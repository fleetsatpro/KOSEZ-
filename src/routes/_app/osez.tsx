...
function OsezPage() {
  ...
  const roomsDone = rooms.filter((r) =>
    hasSource(log, `speak-${r.id}`),
  ).length;
  ...
  return (
    <Page className="kosez-feature-page max-w-4xl">
      ...
      {/* Free topic — any subject → living room */}
      <section className="mt-8 rounded-2xl border border-primary/25 bg-primary/8 p-5 sm:p-6">
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-muted">
          ...
          autour de votre sujet — lieu, interlocuteur, pression, monde réel.
        </p>
      ...
      <div className="mt-12 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 max-w-lg text-sm text-muted">
            Catalogue du jour — lieu, pression, événement réel. Recomposez à
            l'entrée.
          </p>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Lieu, pression et ancrage du jour — recomposés pour vous.
            </p>
          </div>
        </div>
