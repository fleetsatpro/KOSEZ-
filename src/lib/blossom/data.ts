...
export const MISSION_BANK: Mission[] = [
  {
    id: "mission-introduce",
    title: "Se présenter simplement",
    prompt: "Dites votre prénom, votre ville et une chose que vous aimez.",
    context: "Trente à soixante secondes avec une personne nouvelle.",
    durationMin: 2,
    level: "A1",
    language: "English",
    place: "Un café de quartier",
    supportPhrase: "Hi, I'm …",
    successSignals: ["Vous dites votre nom.", "Vous ajoutez une information personnelle.", "Vous gardez une phrase simple jusqu'au bout."],
    realWorldInstruction: "Cette semaine, testez une présentation de trois phrases en anglais.",
    stretch: "Posez une question simple à la personne.",
  },
  {
    id: "mission-order",
    title: "Commander en trois gestes",
    prompt: "Saluez, demandez une boisson et dites merci.",
    context: "Une commande très courte où la réussite vient de l'ordre des gestes.",
    durationMin: 2,
    level: "A1",
    language: "English",
    place: "Comptoir",
    supportPhrase: "I'd like a coffee, please.",
    successSignals: ["Vous saluez.", "Vous formulez la commande.", "Vous terminez naturellement."],
    realWorldInstruction: "Utilisez une commande simple en anglais la prochaine fois que le contexte s'y prête.",
    stretch: "Ajoutez une question sur le prix.",
  },
  {
    id: "mission-place",
    title: "Demander où c'est",
    prompt: "Demandez où se trouve un lieu et remerciez la personne.",
    context: "Une interaction de moins d'une minute.",
    durationMin: 2,
    level: "A1",
    language: "English",
    place: "Dans une rue animée",
    supportPhrase: "Where is the …?",
    successSignals: ["Vous utilisez where.", "Vous nommez le lieu.", "Vous remerciez."],
    realWorldInstruction: "Demandez une information de localisation en anglais au lieu de seulement suivre votre téléphone.",
    stretch: "Demandez si c'est proche.",
  },
  {
    id: "mission-ticket",
    title: "Vérifier un billet",
    prompt: "Demandez l'heure d'un départ et vérifiez que vous avez bien compris.",
    context: "Une petite interaction de transport avec une information précise.",
    durationMin: 3,
    level: "A1",
    language: "English",
    place: "Arrêt de bus",
    supportPhrase: "What time is the next bus?",
    successSignals: ["Vous demandez l'heure.", "Vous écoutez le chiffre.", "Vous confirmez."],
    realWorldInstruction: "Utilisez une question anglaise simple pour vérifier un horaire.",
    stretch: "Demandez aussi le numéro ou la direction.",
  },
  {
    id: "mission-a1-intro",
...

  {
    ...
    prompt: "Saluez un visiteur, demandez ce qu'il cherche et proposez une première aide.",
    context: "Deux à quatre minutes dans un campus, un quartier ou un lieu touristique.",
    durationMin: 3,
    level: "A2",
    language: "English",
    place: "Accueil du quartier",
    supportPhrase: "What are you looking for?",
    successSignals: ["Vous accueillez clairement.", "Vous posez une question utile.", "Vous proposez une prochaine étape."],
    realWorldInstruction: "Quand une personne demande de l'aide cette semaine, essayez une question d'accueil en anglais.",
    stretch: "Donnez deux options au visiteur et demandez ce qui lui convient.",
  },
  {
    id: "mission-checkin",
    title: "Faire un check-in",
    prompt: "Donnez votre nom, confirmez votre réservation et demandez une information pratique.",
    context: "Une interaction courte à une réception ou un comptoir.",
    durationMin: 4,
    level: "A2",
    language: "English",
    place: "Réception",
    supportPhrase: "I'd like to check in.",
    successSignals: ["Vous dites pourquoi vous êtes là.", "Vous confirmez une information.", "Vous posez une question pratique."],
    realWorldInstruction: "Utilisez trois gestes simples : situation, confirmation, question.",
    stretch: "Demandez aussi ce qui est inclus.",
  },
  {
  ...
  {
    id: "mission-summary",
    title: "Résumer une décision",
    prompt: "Expliquez à une personne absente ce qui a été décidé, pourquoi et ce qu'elle doit faire ensuite.",
    context: "Cinq à sept minutes après une réunion, un appel ou une décision pratique.",
    durationMin: 6,
    level: "B1",
    language: "English",
    place: "Après une réunion",
    supportPhrase: "The important thing is …",
    successSignals: [
      "Vous annoncez la décision clairement.",
      "Vous donnez la raison principale.",
      "Vous terminez par une action ou une prochaine étape.",
    ],
    realWorldInstruction: "Prenez une décision réelle cette semaine et transmettez-en l'essentiel à quelqu'un avec vos propres mots.",
    stretch: "Ajoutez une nuance sur ce qui reste à confirmer.",
  },
  {
    id: "mission-delay",
