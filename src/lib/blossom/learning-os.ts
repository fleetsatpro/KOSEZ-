...
const CURRICULUM_RESOURCE_MAP: Record<string, CurriculumResource> = {
  ...
  "u1-l4": { kind: "mission", id: "mission-visitor" },
  ...
  "u2-l5": { kind: "mission", id: "mission-check-in" },
  ...
  "u9-l5": { kind: "mission", id: "mission-summarize" },
  ...
  "u10-l5": { kind: "mission", id: "mission-apologize" },
};
