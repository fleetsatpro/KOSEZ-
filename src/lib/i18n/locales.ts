...
export const UI_LOCALES: UiLocaleDef[] = [
  ...
  },
  {
    ...
    coverage: "partial",
    note: {
      fr: "Chrome central traduit. Certaines surfaces legacy restent à migrer vers t(). Variante britannique pour la synthèse.",
  ...
  },
  {
    ...
    coverage: "partial",
    note: {
      fr: "Chrome central traduit. Certaines surfaces legacy restent à migrer vers t(). Castillan standard.",
  ...
  },
  {
    ...
    coverage: "partial",
    note: {
      fr: "Chrome central traduit. Certaines surfaces legacy restent à migrer vers t(). Variante européenne (Portugal).",
  ...
  },
  {
    ...
    coverage: "partial",
    note: {
      fr: "Chrome central traduit. Certaines surfaces legacy restent à migrer vers t(). Allemand standard.",
  ...
  },
  {
    ...
    coverage: "partial",
    note: {
      fr: "Chrome central traduit. Certaines surfaces legacy restent à migrer vers t(). Italien standard.",
