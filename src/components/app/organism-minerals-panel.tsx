    ...
    <section className="mt-6 rounded-2xl border border-primary/20 bg-primary/5 p-5 sm:p-6 magnetic-surface" aria-label="Les cinq minéraux de l’organisme BLOSSOM">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-fg/90">Chaque chiffre est une respiration sur les <span className="font-medium">{MINERAL_WINDOW_DAYS} derniers jours</span>, pas un niveau de langue. Les chiffres servent à choisir une porte ; ils ne notent pas votre compétence.</p>
        </div>
        <div className="shrink-0 rounded-2xl border border-primary/25 bg-surface px-4 py-3">
          ...
          <p className="mt-1 max-w-xs text-xs leading-5 text-muted">{next.basis}</p>
